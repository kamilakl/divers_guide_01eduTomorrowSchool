...
| **Вложенные циклы** | Первый цикл проходит по аргументам, второй по символам каждого аргумента. Такой подход нужен, потому что `z01.PrintRune()` умеет печатать только отдельные руны. |
